...
Avg_Distance_To_Mpls_Median <- distance_miles_median <- median(consolidated_df$Distance_Miles, na.rm = TRUE)
...
df_rf_recipe <- recipe(log_Match.Length ~ Big.Gender + Ethnicity_Match + Big.Level.of.Education + 
                      ...
                      avg_change_words + Avg_Distance_To_Mpls, data = train_data) %>%
