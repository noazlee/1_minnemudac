...
missmap(consolidated_df, col = c("yellow", "black"), legend = TRUE)
...
time_dependent_model <- coxph(match_surv ~ Big.Gender + Ethnicity_Match + 
                             ...
                             Occupation_Category + positive + latest_sentiment_net + 
...
# rsf_model <- rfsrc(Surv(Match.Length, Stage)~ Big.Gender + Ethnicity_Match + 
#                   Big.Level.of.Education + age_gap_abs + 
#                   Program.Type + SP500_Level + 
#                   avg_change_density + has_interests + 
#                   personality_compatibility + has_goals + 
#                   Occupation_Category + positive + latest_sentiment_net + 
#                   avg_days_between_logs + topic_5_scaled + 
#                   avg_engagement_words + avg_change_words,
#                   data = consolidated_df, ntree = 100)
# 
