...
```{r}
library(survival)
cox_model <- coxph(Surv(Match.Length, Stage) ~ Big.Gender + Big.Age + Program.Type + Occupation_Category + has_interests + has_proximity + has_goals + Ethnicity_Match , data = df)
summary(cox_model)
```
